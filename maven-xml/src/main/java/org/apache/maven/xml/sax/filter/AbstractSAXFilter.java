...
/**
 * XMLFilter with LexicalHandler. Since some filters collect events before processing them, the
 * LexicalHandler events must be collected too. Otherwise the LexicalHandler events might end up
 * before all collected XMLReader events.
 *
