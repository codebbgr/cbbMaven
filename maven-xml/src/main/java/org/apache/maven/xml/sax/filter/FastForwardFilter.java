...
/**
 * This filter will skip all following filters and write directly to the output. Should be used in
 * case of a DOM that should not be effected by other filters, even though the elements match
 *
...
class FastForwardFilter extends AbstractSAXFilter {
   ...
   *
   * <ul>
   *   <li>execution.configuration
   *   <li>plugin.configuration
   *   <li>plugin.goals
   *   <li>profile.reports
   *   <li>project.reports
   *   <li>reportSet.configuration
   *       <ul>
   */
