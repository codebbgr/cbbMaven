...
public class VersionRange {
  ...
  /**
   * @deprecated VersionRange is immutable, cloning is not useful and even more an issue against the
   *     cache
   * @return a clone
   */
  @Deprecated
   ...
   *   <li><code>[1.0,2.0]</code> Versions 1.0 to 2.0 (both included)
   *   <li><code>[1.5,)</code> Versions 1.5 and higher
   *   <li><code>(,1.0],[1.2,)</code> Versions up to 1.0 (included) and 1.2 or higher
   * </ul>
   *
  ...
  private static Restriction parseRestriction(String spec)
    ...
    if (index < 0) {
      ...
      restriction =
          new Restriction(lowerVersion, lowerBoundInclusive, upperVersion, upperBoundInclusive);
    }
  ...
  /**
   * Creates and returns a new <code>VersionRange</code> that is a restriction of this version range
   * and the specified version range.
   *
   * <p>Note: Precedence is given to the recommended version from this version range over the
   ...
   *     <p>The restrictions of the returned version range will be an intersection of the
   *     restrictions of this version range and the specified version range if both version ranges
   *     have restrictions. Otherwise, the restrictions on the returned range will be empty.
   *     <p>The recommended version of the returned version range will be the recommended version of
   *     this version range, provided that ranges falls within the intersected restrictions. If the
   *     restrictions are empty, this version range's recommended version is used if it is not
  ...
  public ArtifactVersion matchVersion(List<ArtifactVersion> versions) {
    // TODO could be more efficient by sorting the list and then moving along the restrictions in
    // order?
