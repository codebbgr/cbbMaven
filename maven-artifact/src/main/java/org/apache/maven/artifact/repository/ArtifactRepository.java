...
/**
 * Abstraction of an artifact repository. Artifact repositories can be remote, local, or even build
 * reactor or IDE workspace.
 */
public interface ArtifactRepository {
   ...
   *
   * @param artifact The artifact whose available versions should be determined, must not be {@code
   *     null}.
  ...
  /**
   * Indicates whether this repository is backed by actual projects. For instance, the build reactor
   * or IDE workspace are examples of such repositories.
   *
