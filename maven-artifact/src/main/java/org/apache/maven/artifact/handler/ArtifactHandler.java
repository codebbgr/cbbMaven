 ...
 *
 * <ul>
 *   <li>extension and classifier, to be able to download the file,
 *   <li>information on how to use the artifact: whether to add it to the classpath, or to take into
 *       account its dependencies.
 * </ul>
 *
