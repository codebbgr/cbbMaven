...
public class Plugin extends ConfigurationContainer
  ...
  /**
   * Whether to load Maven extensions (such as packaging and type handlers) from this plugin. For
   * performance reasons, this should only be enabled when necessary. Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code>. Default value is <code>false</code>.
   */
      ...
      if (this.goals != null) {
        copy.goals =
            new org.codehaus.plexus.util.xml.Xpp3Dom(
                (org.codehaus.plexus.util.xml.Xpp3Dom) this.goals);
      }
   ...
   * For performance reasons, this should only be enabled when necessary. Note: While the type of
   * this field is <code>String</code> for technical reasons, the semantic type is actually <code>
   * Boolean</code>. Default value is <code>false</code>.
   *
   * @return String
   */
  ...
  /**
   * Set multiple specifications of a set of goals to execute during the build lifecycle, each
   * having (possibly) a different configuration.
   *
   * @param executions
   */
