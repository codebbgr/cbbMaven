...
/**
 * This elements describes all that pertains to distribution for a project. It is primarily used for
...
public class DistributionManagement
  ...
  /**
   * Where to deploy snapshots of artifacts to. If not given, it defaults to the <code>repository
   * </code> element.
   */
  ...
  /**
   * The URL of the project's download page. If not given users will be referred to the homepage
   * given by <code>url</code>. This is given to assist in locating artifacts that are not in the
   * repository due to licensing restrictions.
   */
  private String downloadUrl;

  /**
   * Relocation information of the artifact if it has been moved to a new group ID and/or artifact
   * ID.
   */
   ...
   * project, as it is updated by tools placing it in the reposiory. Valid values are: <code>none
   * </code> (default), <code>converted</code> (repository manager converted this from an Maven 1
   * POM), <code>partner</code> (directly synced from a partner Maven 2 repository), <code>deployed
   * </code> (was deployed from a Maven 2 instance), <code>verified</code> (has been hand verified
  ...
  /**
   * Get the URL of the project's download page. If not given users will be referred to the homepage
   * given by <code>url</code>. This is given to assist in locating artifacts that are not in the
   * repository due to licensing restrictions.
   *
   * @return String
  ...
  /**
   * Get relocation information of the artifact if it has been moved to a new group ID and/or
   * artifact ID.
   *
   * @return Relocation
   */
  ...
  /**
   * Get where to deploy snapshots of artifacts to. If not given, it defaults to the <code>
   * repository</code> element.
   *
   * @return DeploymentRepository
   */
  ...
  /**
   * Get gives the status of this artifact in the remote repository. This must not be set in your
   * local project, as it is updated by tools placing it in the reposiory. Valid values are: <code>
   * none</code> (default), <code>converted</code> (repository manager converted this from an Maven
   * 1 POM), <code>partner</code> (directly synced from a partner Maven 2 repository), <code>
   * deployed</code> (was deployed from a Maven 2 instance), <code>verified</code> (has been hand
  ...
  /**
   * Set the URL of the project's download page. If not given users will be referred to the homepage
   * given by <code>url</code>. This is given to assist in locating artifacts that are not in the
   * repository due to licensing restrictions.
   *
   * @param downloadUrl
  ...
  /**
   * Set relocation information of the artifact if it has been moved to a new group ID and/or
   * artifact ID.
   *
   * @param relocation
   */
  ...
  /**
   * Set where to deploy snapshots of artifacts to. If not given, it defaults to the <code>
   * repository</code> element.
   *
  ...
  /**
   * Set gives the status of this artifact in the remote repository. This must not be set in your
   * local project, as it is updated by tools placing it in the reposiory. Valid values are: <code>
   * none</code> (default), <code>converted</code> (repository manager converted this from an Maven
   * 1 POM), <code>partner</code> (directly synced from a partner Maven 2 repository), <code>
   * deployed</code> (was deployed from a Maven 2 instance), <code>verified</code> (has been hand
