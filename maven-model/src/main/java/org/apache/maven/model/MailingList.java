...
/**
 * This element describes all of the mailing lists associated with a project. The auto-generated
...
public class MailingList
  ...
  /**
   * The email address or link that can be used to subscribe to the mailing list. If this is an
   * email address, a <code>mailto:</code> link will automatically be created when the documentation
   * is created.
   */
  private String subscribe;

  /**
   * The email address or link that can be used to unsubscribe to the mailing list. If this is an
   * email address, a <code>mailto:</code> link will automatically be created when the documentation
   * is created.
   */
  ...
  /**
   * The email address or link that can be used to post to the mailing list. If this is an email
   * address, a <code>mailto:</code> link will automatically be created when the documentation is
   * created.
   */
  private String post;
  ...
  /**
   * Get the email address or link that can be used to post to the mailing list. If this is an email
   * address, a <code>mailto:</code> link will automatically be created when the documentation is
   * created.
   *
   * @return String
  ...
  /**
   * Get the email address or link that can be used to subscribe to the mailing list. If this is an
   * email address, a <code>mailto:</code> link will automatically be created when the documentation
   * is created.
   *
   * @return String
  ...
  /**
   * Get the email address or link that can be used to unsubscribe to the mailing list. If this is
   * an email address, a <code>mailto:</code> link will automatically be created when the
  ...
  /**
   * Set the email address or link that can be used to post to the mailing list. If this is an email
   * address, a <code>mailto:</code> link will automatically be created when the documentation is
   * created.
   *
   * @param post
  ...
  /**
   * Set the email address or link that can be used to subscribe to the mailing list. If this is an
   * email address, a <code>mailto:</code> link will automatically be created when the documentation
   * is created.
   *
   * @param subscribe
  ...
  /**
   * Set the email address or link that can be used to unsubscribe to the mailing list. If this is
   * an email address, a <code>mailto:</code> link will automatically be created when the
   * documentation is created.
   *
   * @param unsubscribe
