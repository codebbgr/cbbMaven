...
public class ConfigurationContainer
  ...
  /**
   * Whether any configuration should be propagated to child POMs. Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code>. Default value is <code>true</code>.
   */
   ...
   * <code>xml:space="preserve"</code> to elements you want to preserve whitespace.
   *
   * <p>You can control how child POMs inherit configuration from parent POMs by adding <code>
   * combine.children</code> or <code>combine.self</code> attributes to the children of the
   * configuration element:
   *
   * <ul>
   *   <li><code>combine.children</code>: available values are <code>merge</code> (default) and
   *       <code>append</code>,
   *   <li><code>combine.self</code>: available values are <code>merge</code> (default) and <code>
   *       override</code>.
   * </ul>
   *
  ...
  /**
   * Get whether any configuration should be propagated to child POMs. Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code>. Default value is <code>true</code>.
   *
   * @return String
  ...
  /**
   * Set whether any configuration should be propagated to child POMs. Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code>. Default value is <code>true</code>.
   *
   * @param inherited
