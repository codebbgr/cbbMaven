...
/**
 * This is the file specification used to activate the profile. The <code>missing</code> value is
 * the location of a file that needs to exist, and if it doesn't, the profile will be activated. On
 * the other hand, <code>exists</code> will test for the existence of the file and if it is there,
 * the profile will be activated.<br>
