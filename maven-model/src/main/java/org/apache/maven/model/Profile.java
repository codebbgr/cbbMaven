...
public class Profile extends ModelBase implements java.io.Serializable, java.lang.Cloneable {
  ...
  /**
   * The identifier of this build profile. This is used for command line activation, and identifies
  ...
  /**
   * Get the identifier of this build profile. This is used for command line activation, and
   * identifies profiles to be merged.
   *
   * @return String
   */
  public String getId() {
  ...
  /**
   * Set the identifier of this build profile. This is used for command line activation, and
   * identifies profiles to be merged.
   *
   * @param id
   */
