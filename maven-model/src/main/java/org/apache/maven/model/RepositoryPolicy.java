...
public class RepositoryPolicy
  ...
  /**
   * Whether to use this repository for downloading this type of artifact. Note: While the type of
   * this field is <code>String</code> for technical reasons, the semantic type is actually <code>
   * Boolean</code>. Default value is <code>true</code>.
   */
  private String enabled;

  /**
   * The frequency for downloading updates - can be <code>always,</code> <code>daily</code>
   * (default), <code>interval:XXX</code> (in minutes) or <code>never</code> (only if it doesn't
   * exist locally).
   */
  private String updatePolicy;

  /**
   * What to do when verification of an artifact checksum fails. Valid values are <code>ignore
   * </code> , <code>fail</code> or <code>warn</code> (the default).
   */
  ...
  /**
   * Get what to do when verification of an artifact checksum fails. Valid values are <code>ignore
   * </code> , <code>fail</code> or <code>warn</code> (the default).
   *
   * @return String
   */
  ...
  /**
   * Get the frequency for downloading updates - can be <code>always,</code> <code>daily</code>
   * (default), <code>interval:XXX</code> (in minutes) or <code>never</code> (only if it doesn't
   * exist locally).
   *
   * @return String
  ...
  /**
   * Set what to do when verification of an artifact checksum fails. Valid values are <code>ignore
   * </code> , <code>fail</code> or <code>warn</code> (the default).
   *
  ...
  /**
   * Set whether to use this repository for downloading this type of artifact. Note: While the type
   * of this field is <code>String</code> for technical reasons, the semantic type is actually
   * <code>Boolean</code>. Default value is <code>true</code>.
   *
   * @param enabled
  ...
  /**
   * Set the frequency for downloading updates - can be <code>always,</code> <code>daily</code>
   * (default), <code>interval:XXX</code> (in minutes) or <code>never</code> (only if it doesn't
   * exist locally).
   *
   * @param updatePolicy
