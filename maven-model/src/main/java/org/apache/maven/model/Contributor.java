...
/**
 * Description of a person who has contributed to the project, but who does not have commit
 * privileges. Usually, these contributions come in the form of patches submitted.
 *
...
public class Contributor
  ...
  /**
   * The timezone the contributor is in. Typically, this is a number in the range <a
   * href="http://en.wikipedia.org/wiki/UTC%E2%88%9212:00">-12</a> to <a
   * href="http://en.wikipedia.org/wiki/UTC%2B14:00">+14</a> or a valid time zone id like
   * "America/Montreal" (UTC-05:00) or "Europe/Paris" (UTC+01:00).
   */
  ...
  /**
   * Get the timezone the contributor is in. Typically, this is a number in the range <a
   * href="http://en.wikipedia.org/wiki/UTC%E2%88%9212:00">-12</a> to <a
   * href="http://en.wikipedia.org/wiki/UTC%2B14:00">+14</a> or a valid time zone id like
   * "America/Montreal" (UTC-05:00) or "Europe/Paris" (UTC+01:00).
   *
  ...
  /**
   * Set the roles the contributor plays in the project. Each role is described by a <code>role
   * </code> element, the body of which is a role name. This can also be used to describe the
   * contribution.
   *
   * @param roles
   */
  ...
  /**
   * Set the timezone the contributor is in. Typically, this is a number in the range <a
   * href="http://en.wikipedia.org/wiki/UTC%E2%88%9212:00">-12</a> to <a
   * href="http://en.wikipedia.org/wiki/UTC%2B14:00">+14</a> or a valid time zone id like
   * "America/Montreal" (UTC-05:00) or "Europe/Paris" (UTC+01:00).
   *
