...
public class ReportSet extends ConfigurationContainer
  ...
  /**
   * The unique id for this report set, to be used during POM inheritance and profile injection for
  ...
  /**
   * Get the unique id for this report set, to be used during POM inheritance and profile injection
  ...
  /**
   * Set the unique id for this report set, to be used during POM inheritance and profile injection
   * for merging of report sets.
   *
   * @param id
   */
