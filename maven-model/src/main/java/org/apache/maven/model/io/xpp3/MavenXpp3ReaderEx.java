...
public class MavenXpp3ReaderEx {
  ...
  /**
   * If set the parser will be loaded with all single characters from the XHTML specification. The
   * entities used:
   *
   * <ul>
   *   <li>http://www.w3.org/TR/xhtml1/DTD/xhtml-lat1.ent
   *   <li>http://www.w3.org/TR/xhtml1/DTD/xhtml-special.ent
   *   <li>http://www.w3.org/TR/xhtml1/DTD/xhtml-symbol.ent
   * </ul>
   */
  ...
  private boolean checkFieldWithDuplicate(
      XmlPullParser parser, String tagName, String alias, java.util.Set parsed)
      throws XmlPullParserException {
   ...
   * @throws IOException
   */
  private void checkUnknownAttribute(
      XmlPullParser parser, String attribute, String tagName, boolean strict)
      throws XmlPullParserException, IOException {
    // strictXmlAttributes = true for model: if strict == true, not only elements are checked but
    // attributes too
    if (strict) {
  ...
  private void checkUnknownElement(XmlPullParser parser, boolean strict)
    ...
    if (strict) {
      throw new XmlPullParserException(
          "Unrecognised tag: '" + parser.getName() + "'", parser, null);
    }
  ...
  private boolean getBooleanValue(
      String s, String attribute, XmlPullParser parser, String defaultValue)
      throws XmlPullParserException {
   ...
   * @return Date
   */
  private java.util.Date getDateValue(
      String s, String attribute, String dateFormat, XmlPullParser parser)
      throws XmlPullParserException {
    if (s != null) {
      ...
      if ("long".equals(effectiveDateFormat)) {
        ...
        try {
          DateFormat dateParser =
              new java.text.SimpleDateFormat(effectiveDateFormat, java.util.Locale.US);
   ...
   * @return String
   */
  private String getRequiredAttributeValue(
      String s, String attribute, XmlPullParser parser, boolean strict)
      throws XmlPullParserException {
    if (s == null) {
      if (strict) {
        throw new XmlPullParserException(
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "activeByDefault", null, parsed)) {
        ...
        activation.setActiveByDefault(
            getBooleanValue(
                interpolatedTrimmed(parser.nextText(), "activeByDefault"),
                "activeByDefault",
                parser,
                "false"));
   ...
   */
  private ActivationFile parseActivationFile(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
   ...
   */
  private ActivationProperty parseActivationProperty(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "sourceDirectory", null, parsed)) {
        ...
        build.setScriptSourceDirectory(
            interpolatedTrimmed(parser.nextText(), "scriptSourceDirectory"));
  ...
  private ConfigurationContainer parseConfigurationContainer(
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "inherited", null, parsed)) {
        ...
        configurationContainer.setConfiguration(
            org.codehaus.plexus.util.xml.Xpp3DomBuilder.build(
                parser, true, new Xpp3DomBuilderInputLocationBuilder(_location)));
      } else {
        checkUnknownElement(parser, strict);
      }
    }
   ...
   */
  private DependencyManagement parseDependencyManagement(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
   ...
   */
  private DeploymentRepository parseDeploymentRepository(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "uniqueVersion", null, parsed)) {
        ...
        deploymentRepository.setUniqueVersion(
            getBooleanValue(
                interpolatedTrimmed(parser.nextText(), "uniqueVersion"),
                "uniqueVersion",
                parser,
                "true"));
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "repository", null, parsed)) {
        ...
        distributionManagement.setSnapshotRepository(
            parseDeploymentRepository(parser, strict, source));
        ...
        distributionManagement.setDownloadUrl(
            interpolatedTrimmed(parser.nextText(), "downloadUrl"));
   ...
   */
  private IssueManagement parseIssueManagement(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
    ...
    for (int i = parser.getAttributeCount() - 1; i >= 0; i--) {
      ...
      if (name.indexOf(':') >= 0) {
        ...
        model.setChildProjectUrlInheritAppendPath(
            interpolatedTrimmed(value, "child.project.url.inherit.append.path"));
      } else {
        checkUnknownAttribute(parser, name, tagName, strict);
      }
    }
  ...
  private Notifier parseNotifier(XmlPullParser parser, boolean strict, InputSource source)
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "type", null, parsed)) {
        ...
        notifier.setSendOnError(
            getBooleanValue(
                interpolatedTrimmed(parser.nextText(), "sendOnError"),
                "sendOnError",
                parser,
                "true"));
        ...
        notifier.setSendOnFailure(
            getBooleanValue(
                interpolatedTrimmed(parser.nextText(), "sendOnFailure"),
                "sendOnFailure",
                parser,
                "true"));
        ...
        notifier.setSendOnSuccess(
            getBooleanValue(
                interpolatedTrimmed(parser.nextText(), "sendOnSuccess"),
                "sendOnSuccess",
                parser,
                "true"));
        ...
        notifier.setSendOnWarning(
            getBooleanValue(
                interpolatedTrimmed(parser.nextText(), "sendOnWarning"),
                "sendOnWarning",
                parser,
                "true"));
   ...
   */
  private PluginConfiguration parsePluginConfiguration(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
   ...
   */
  private PluginContainer parsePluginContainer(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
   ...
   */
  private PluginExecution parsePluginExecution(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "id", null, parsed)) {
        ...
        pluginExecution.setConfiguration(
            org.codehaus.plexus.util.xml.Xpp3DomBuilder.build(
                parser, true, new Xpp3DomBuilderInputLocationBuilder(_location)));
      } else {
        checkUnknownElement(parser, strict);
   ...
   */
  private PluginManagement parsePluginManagement(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
   ...
   */
  private RepositoryBase parseRepositoryBase(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
   ...
   */
  private RepositoryPolicy parseRepositoryPolicy(
      XmlPullParser parser, boolean strict, InputSource source)
      throws IOException, XmlPullParserException {
    String tagName = parser.getName();
    ...
    while ((strict ? parser.nextTag() : nextTag(parser)) == XmlPullParser.START_TAG) {
      if (checkFieldWithDuplicate(parser, "enabled", null, parsed)) {
        ...
        repositoryPolicy.setChecksumPolicy(
            interpolatedTrimmed(parser.nextText(), "checksumPolicy"));
      } else {
        checkUnknownElement(parser, strict);
      }
    }
  ...
  private Scm parseScm(XmlPullParser parser, boolean strict, InputSource source)
    ...
    for (int i = parser.getAttributeCount() - 1; i >= 0; i--) {
      ...
      if (name.indexOf(':') >= 0) {
        ...
        scm.setChildScmConnectionInheritAppendPath(
            interpolatedTrimmed(value, "child.scm.connection.inherit.append.path"));
        ...
        scm.setChildScmDeveloperConnectionInheritAppendPath(
            interpolatedTrimmed(value, "child.scm.developerConnection.inherit.append.path"));
      } else if ("child.scm.url.inherit.append.path".equals(name)) {
        _location = new InputLocation(parser.getLineNumber(), parser.getColumnNumber(), source);
        scm.setLocation("childScmUrlInheritAppendPath", _location);
        scm.setChildScmUrlInheritAppendPath(
            interpolatedTrimmed(value, "child.scm.url.inherit.append.path"));
      } else {
        checkUnknownAttribute(parser, name, tagName, strict);
      }
    }
  ...
  private Site parseSite(XmlPullParser parser, boolean strict, InputSource source)
    ...
    for (int i = parser.getAttributeCount() - 1; i >= 0; i--) {
      ...
      if (name.indexOf(':') >= 0) {
        ...
        site.setChildSiteUrlInheritAppendPath(
            interpolatedTrimmed(value, "child.site.url.inherit.append.path"));
      } else {
        checkUnknownAttribute(parser, name, tagName, strict);
      }
    }
  ...
  private static class Xpp3DomBuilderInputLocationBuilder
    ...
    public Object toInputLocation(XmlPullParser parser) {
      return new InputLocation(
          parser.getLineNumber(), parser.getColumnNumber(), rootLocation.getSource());
  ...
  public static interface ContentTransformer {
     ...
     * @param fieldName A description of the field being interpolated. The implementation may use
     *     this to log stuff.
