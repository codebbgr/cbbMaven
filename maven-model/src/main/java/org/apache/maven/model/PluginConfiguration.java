...
public class PluginConfiguration extends PluginContainer
  ...
  /**
   * Default plugin information to be made available for reference by projects derived from this
   * one. This plugin configuration will not be resolved or bound to the lifecycle unless
   * referenced. Any local configuration for a given plugin will override the plugin's entire
   * definition here.
   */
  ...
  /**
   * Get default plugin information to be made available for reference by projects derived from this
   * one. This plugin configuration will not be resolved or bound to the lifecycle unless
   * referenced. Any local configuration for a given plugin will override the plugin's entire
   * definition here.
   *
  ...
  /**
   * Set default plugin information to be made available for reference by projects derived from this
   * one. This plugin configuration will not be resolved or bound to the lifecycle unless
   * referenced. Any local configuration for a given plugin will override the plugin's entire
   * definition here.
   *
