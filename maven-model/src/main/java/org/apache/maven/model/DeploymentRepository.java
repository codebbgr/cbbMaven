...
public class DeploymentRepository extends Repository
  ...
  /**
   * Get whether to assign snapshots a unique version comprised of the timestamp and build number,
   * or to use the same version each time.
   *
   * @return boolean
   */
  ...
  /**
   * Set whether to assign snapshots a unique version comprised of the timestamp and build number,
   * or to use the same version each time.
   *
   * @param uniqueVersion
   */
