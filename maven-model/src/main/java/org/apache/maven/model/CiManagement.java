...
/**
 * The <code>&lt;CiManagement&gt;</code> element contains informations required to the continuous
 * integration system of the project.
 *
...
public class CiManagement
  ...
  /**
   * Set configuration for notifying developers/users when a build is unsuccessful, including user
   * information and notification mode.
   *
   * @param notifiers
   */
