...
/**
 * The conditions within the build runtime environment which will trigger the automatic inclusion of
 * the build profile. Multiple conditions can be defined, which must be all satisfied to activate
 * the profile.
 *
...
public class Activation
   ...
   * using the command line -P option or by one of that profile's activators.
   */
   ...
   * <code>1.4</code> only activates on JDKs versioned 1.4, while <code>!1.4</code> matches any JDK
   * that is not version 1.4. Ranges are supported too: <code>[1.5,)</code> activates when the JDK
   * is 1.5 minimum.
   */
  private String jdk;

  /**
   * Specifies that this profile will be activated when matching operating system attributes are
   * detected.
   */
  ...
  /**
   * Get specifies that this profile will be activated when a matching JDK is detected. For example,
   * <code>1.4</code> only activates on JDKs versioned 1.4, while <code>!1.4</code> matches any JDK
   * that is not version 1.4. Ranges are supported too: <code>[1.5,)</code> activates when the JDK
   * is 1.5 minimum.
   *
  ...
  /**
   * Get specifies that this profile will be activated when matching operating system attributes are
   * detected.
   *
   * @return ActivationOS
   */
  ...
  /**
   * Get if set to true, this profile will be active unless another profile in this pom is activated
   * using the command line -P option or by one of that profile's activators.
   *
   * @return boolean
   */
  ...
  /**
   * Set if set to true, this profile will be active unless another profile in this pom is activated
   * using the command line -P option or by one of that profile's activators.
   *
  ...
  /**
   * Set specifies that this profile will be activated when a matching JDK is detected. For example,
   * <code>1.4</code> only activates on JDKs versioned 1.4, while <code>!1.4</code> matches any JDK
   * that is not version 1.4. Ranges are supported too: <code>[1.5,)</code> activates when the JDK
   * is 1.5 minimum.
   *
  ...
  /**
   * Set specifies that this profile will be activated when matching operating system attributes are
   * detected.
   *
   * @param os
   */
