...
public class Reporting
   ...
   * reports in the "Project Info" menu. Note: While the type of this field is <code>String</code>
  ...
  /**
   * Where to store all of the generated reports. The default is <code>
  ...
  /**
   * Get if true, then the default reports are not included in the site generation. This includes
   * the reports in the "Project Info" menu. Note: While the type of this field is <code>String
  ...
  /**
   * Get where to store all of the generated reports. The default is <code>
   * ${project.build.directory}/site</code>.
   *
   * @return String
   */
  ...
  /**
   * Set if true, then the default reports are not included in the site generation. This includes
   * the reports in the "Project Info" menu. Note: While the type of this field is <code>String
   * </code> for technical reasons, the semantic type is actually <code>Boolean</code>. Default
   * value is <code>false</code>.
   *
  ...
  /**
   * Set where to store all of the generated reports. The default is <code>
   * ${project.build.directory}/site</code>.
   *
