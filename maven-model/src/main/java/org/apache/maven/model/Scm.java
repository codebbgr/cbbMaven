...
/**
 * The <code>&lt;scm&gt;</code> element contains informations required to the SCM (Source Control
...
public class Scm
  ...
  /**
   * The source control management system URL that describes the repository and how to connect to
   * the repository. For more information, see the <a
   * href="https://maven.apache.org/scm/scm-url-format.html">URL format</a> and <a
   * href="https://maven.apache.org/scm/scms-overview.html">list of supported SCMs</a>. This
   * connection is read-only. <br>
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if scm's <code>child.scm.connection.inherit.append.path="false"
   * </code>
   */
  private String connection;

  /**
   * Just like <code>connection</code>, but for developers, i.e. this scm connection will not be
   * read only. <br>
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if scm's <code>
   * child.scm.developerConnection.inherit.append.path="false"</code>
   */
   ...
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if scm's <code>child.scm.url.inherit.append.path="false"</code>
   */
  private String url;

  /**
   * When children inherit from scm connection, append path or not? Note: While the type of this
   ...
   * <code>String</code> for technical reasons, the semantic type is actually <code>Boolean</code>
   * <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1
   *
  ...
  /**
   * Get when children inherit from scm connection, append path or not? Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
  ...
  /**
   * Get when children inherit from scm developer connection, append path or not? Note: While the
   * type of this field is <code>String</code> for technical reasons, the semantic type is actually
   * <code>Boolean</code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
   *
  ...
  /**
   * Get when children inherit from scm url, append path or not? Note: While the type of this field
   * is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
   *
  ...
  /**
   * Get the source control management system URL that describes the repository and how to connect
  ...
  /**
   * Get just like <code>connection</code>, but for developers, i.e. this scm connection will not be
   * read only. <br>
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if scm's <code>
   * child.scm.developerConnection.inherit.append.path="false"</code>
  ...
  /**
   * Set when children inherit from scm connection, append path or not? Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
  ...
  /**
   * Set when children inherit from scm developer connection, append path or not? Note: While the
   * type of this field is <code>String</code> for technical reasons, the semantic type is actually
   * <code>Boolean</code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
   ...
   */
  public void setChildScmDeveloperConnectionInheritAppendPath(
  ...
  /**
   * Set when children inherit from scm url, append path or not? Note: While the type of this field
   * is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
  ...
  /**
   * Set the source control management system URL that describes the repository and how to connect
   * to the repository. For more information, see the <a
   * href="https://maven.apache.org/scm/scm-url-format.html">URL format</a> and <a
   * href="https://maven.apache.org/scm/scms-overview.html">list of supported SCMs</a>. This
   * connection is read-only. <br>
  ...
  /**
   * Set just like <code>connection</code>, but for developers, i.e. this scm connection will not be
   * read only. <br>
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if scm's <code>
   * child.scm.developerConnection.inherit.append.path="false"</code>
  ...
  public boolean isChildScmConnectionInheritAppendPath() {
    return (childScmConnectionInheritAppendPath != null)
        ? Boolean.parseBoolean(childScmConnectionInheritAppendPath)
        : true;
  }
  ...
  public boolean isChildScmDeveloperConnectionInheritAppendPath() {
    return (childScmDeveloperConnectionInheritAppendPath != null)
        ? Boolean.parseBoolean(childScmDeveloperConnectionInheritAppendPath)
        : true;
  }
  ...
  public void setChildScmDeveloperConnectionInheritAppendPath(
    ...
    this.childScmDeveloperConnectionInheritAppendPath =
        String.valueOf(childScmDeveloperConnectionInheritAppendPath);
  }

  public boolean isChildScmUrlInheritAppendPath() {
    return (childScmUrlInheritAppendPath != null)
        ? Boolean.parseBoolean(childScmUrlInheritAppendPath)
        : true;
  }
