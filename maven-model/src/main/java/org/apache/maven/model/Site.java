...
public class Site
  ...
  /**
   * A unique identifier for a deployment location. This is used to match the site to configuration
   * in the <code>settings.xml</code> file, for example.
   */
  private String id;
   ...
   * property), or just parent value if site's <code>child.site.url.inherit.append.path="false"
   * </code>
   */
  private String url;

  /**
   * When children inherit from distribution management site url, append path or not? Note: While
   * the type of this field is <code>String</code> for technical reasons, the semantic type is
   * actually <code>Boolean</code> <br>
  ...
  /**
   * Get when children inherit from distribution management site url, append path or not? Note:
   * While the type of this field is <code>String</code> for technical reasons, the semantic type is
   * actually <code>Boolean</code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
   *
  ...
  /**
   * Get a unique identifier for a deployment location. This is used to match the site to
   * configuration in the <code>settings.xml</code> file, for example.
   *
   * @return String
   */
  public String getId() {
  ...
  /**
   * Get the url of the location where website is deployed, in the form <code>
   * protocol://hostname/path</code>. <br>
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if site's <code>child.site.url.inherit.append.path="false"
   * </code>
   *
  ...
  /**
   * Set when children inherit from distribution management site url, append path or not? Note:
   * While the type of this field is <code>String</code> for technical reasons, the semantic type is
   * actually <code>Boolean</code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
  ...
  /**
   * Set a unique identifier for a deployment location. This is used to match the site to
   * configuration in the <code>settings.xml</code> file, for example.
   *
   * @param id
   */
  ...
  /**
   * Set the url of the location where website is deployed, in the form <code>
   * protocol://hostname/path</code>. <br>
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if site's <code>child.site.url.inherit.append.path="false"
   * </code>
  ...
  public boolean isChildSiteUrlInheritAppendPath() {
    return (childSiteUrlInheritAppendPath != null)
        ? Boolean.parseBoolean(childSiteUrlInheritAppendPath)
        : true;
  }
