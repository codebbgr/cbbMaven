...
public class Model extends ModelBase implements java.io.Serializable, java.lang.Cloneable {
  ...
  /**
   * The location of the parent project, if one exists. Values from the parent project will be the
   * default for this project if they are left unspecified. The location is given as a group ID,
   * artifact ID and version.
   */
  private Parent parent;

  /**
   * A universally unique identifier for a project. It is normal to use a fully-qualified package
   * name to distinguish it from other projects with a similar name (eg. <code>org.apache.maven
   * </code>).
   */
  private String groupId;

  /**
   * The identifier for this artifact that is unique within the group given by the group ID. An
   ...
   * such as on the web site. While this element can be specified as CDATA to enable the use of HTML
   * tags within the description, it is discouraged to allow plain text representation. If you need
   * to modify the index page of the generated web site, you are able to specify your own instead of
   * adjusting this text.
   */
   ...
   * <b>Default value is</b>: parent value [+ path adjustment] + (artifactId or project.directory
   * property), or just parent value if project's <code>
   * child.project.url.inherit.append.path="false"</code>
   */
  private String url;

  /**
   * When children inherit from project's url, append path or not? Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1
   *
   * <p>.
   */
  ...
  /**
   * The year of the project's inception, specified with 4 digits. This value is used when
   * generating copyright notices as well as being informational.
   */
  ...
  /**
   * Get when children inherit from project's url, append path or not? Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
  ...
  /**
   * Get the year of the project's inception, specified with 4 digits. This value is used when
   * generating copyright notices as well as being informational.
   *
   * @return String
   */
  ...
  /**
   * Set the identifier for this artifact that is unique within the group given by the group ID. An
   * artifact is something that is either produced or used by a project. Examples of artifacts
   * produced by Maven for a project include: JARs, source and binary distributions, and WARs.
   *
   * @param artifactId
  ...
  /**
   * Set when children inherit from project's url, append path or not? Note: While the type of this
   * field is <code>String</code> for technical reasons, the semantic type is actually <code>Boolean
   * </code> <br>
   * <b>Default value is</b>: <code>true</code> <br>
   * <b>Since</b>: Maven 3.6.1.
  ...
  /**
   * Set a detailed description of the project, used by Maven whenever it needs to describe the
   * project, such as on the web site. While this element can be specified as CDATA to enable the
   * use of HTML tags within the description, it is discouraged to allow plain text representation.
   * If you need to modify the index page of the generated web site, you are able to specify your
   * own instead of adjusting this text.
  ...
  /**
   * Set a universally unique identifier for a project. It is normal to use a fully-qualified
   * package name to distinguish it from other projects with a similar name (eg. <code>
   * org.apache.maven</code>).
   *
   * @param groupId
  ...
  /**
   * Set the year of the project's inception, specified with 4 digits. This value is used when
   * generating copyright notices as well as being informational.
   *
   * @param inceptionYear
   */
  ...
  /**
   * Set this element describes all of the licenses for this project. Each license is described by a
   ...
   * dependencies. If multiple licenses are listed, it is assumed that the user can select any of
   * them, not that they must accept all.
   *
   * @param licenses
   */
  ...
  /**
   * Set the type of artifact this project produces, for example <code>jar</code> <code>war</code>
   * <code>ear</code> <code>pom</code>. Plugins can create their own packaging, and therefore their
   * own packaging types, so this list does not contain all possible types.
   *
   * @param packaging
  ...
  /**
   * Set the location of the parent project, if one exists. Values from the parent project will be
   * the default for this project if they are left unspecified. The location is given as a group ID,
   * artifact ID and version.
   *
   * @param parent
  ...
  /**
   * Set a listing of project-local build profiles which will modify the build process when
   * activated.
   *
   * @param profiles
   */
  ...
  /**
   * The POM from which this model originated. This is transient runtime state and therefore not
   * managed by Modello.
   */
   ...
   *
   * @return The POM file from which this model originated or {@code null} if this model does not
   *     belong to a local project (e.g. describes the metadata of some artifact from the
   *     repository).
   */
   ...
   *
   * @return The base directory for the corresponding project or {@code null} if this model does not
   *     belong to a local project (e.g. describes the metadata of some artifact from the
   *     repository).
   */
  ...
  public boolean isChildProjectUrlInheritAppendPath() {
    return (childProjectUrlInheritAppendPath != null)
        ? Boolean.parseBoolean(childProjectUrlInheritAppendPath)
        : true;
  }
