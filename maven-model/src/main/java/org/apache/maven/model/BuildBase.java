...
public class BuildBase extends PluginConfiguration
  ...
  /**
   * The default goal (or phase in Maven 2) to execute when none is specified for the project. Note
   * that in case of a multi-module build, only the default goal of the top-level project is
   * relevant, i.e. the default goals of child modules are ignored. Since Maven 3, multiple
   * goals/phases can be separated by whitespace.
   */
  ...
  /**
   * The directory where all files generated by the build are placed. The default value is <code>
   * target</code>.
   */
   ...
   * Note that in case of a multi-module build, only the default goal of the top-level project is
   * relevant, i.e. the default goals of child modules are ignored. Since Maven 3, multiple
   * goals/phases can be separated by whitespace.
   *
   * @return String
  ...
  /**
   * Get the filename (excluding the extension, and with no path information) that the produced
   * artifact will be called. The default value is <code>${artifactId}-${version}</code>.
   *
   * @return String
   */
  ...
  /**
   * Set the directory where all files generated by the build are placed. The default value is
   * <code>target</code>.
   *
   * @param directory
   */
  ...
  /**
   * Set the filename (excluding the extension, and with no path information) that the produced
   * artifact will be called. The default value is <code>${artifactId}-${version}</code>.
   *
   * @param finalName
   */
  ...
  /**
   * Set this element describes all of the classpath resources such as properties files associated
   * with a project. These resources are often included in the final package. The default value is
  ...
  /**
   * Set this element describes all of the classpath resources such as properties files associated
   * with a project's unit tests. The default value is <code>src/test/resources</code>.
   *
   * @param testResources
   */
