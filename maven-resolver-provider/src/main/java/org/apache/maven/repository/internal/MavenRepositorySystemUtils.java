...
/**
 * A utility class to assist in setting up a Maven-like repository system. <em>Note:</em> This
 * component is meant to assist those clients that employ the repository system outside of an IoC
 * container, Maven plugins should instead always use regular dependency injection to acquire the
 * repository system.
 *
