...
public interface Problem {
   ...
   * for such a source hint can be the file path or URL from which the settings were read.
   *
   * @return The hint about the source of the problem or an empty string if unknown, never {@code
   *     null}.
   */
  String getSource();
  ...
  /**
   * Gets the location of the problem. The location is a user-friendly combination of the values
   * from {@link #getSource()}, {@link #getLineNumber()} and {@link #getColumnNumber()}. The exact
