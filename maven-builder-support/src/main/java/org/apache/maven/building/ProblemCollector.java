...
public interface ProblemCollector {
   ...
   * @param column The one-based index of the column containing the problem or {@code -1} if
   *     unknown.
   ...
   * messages keep their source, but the next messages will use the new source.
   *
   * @param source
   */
