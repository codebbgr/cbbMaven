...
public class SnapshotVersion implements java.io.Serializable, java.lang.Cloneable {
  ...
  /**
   * The timestamp when this version information was last updated. The timestamp is expressed using
   * UTC in the format yyyyMMddHHmmss.
   */
  ...
  /**
   * Get the timestamp when this version information was last updated. The timestamp is expressed
   * using UTC in the format yyyyMMddHHmmss.
   *
   * @return String
   */
  ...
  /**
   * Set the timestamp when this version information was last updated. The timestamp is expressed
   * using UTC in the format yyyyMMddHHmmss.
   *
   * @param updated
   */
