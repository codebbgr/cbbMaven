...
public interface ModelWriter {
  ...
  /**
   * Writes the supplied model to the specified file. Any non-existing parent directories of the
   * output file will be created automatically.
   *
   * @param output The file to serialize the model to, must not be {@code null}.
   * @param options The options to use for serialization, may be {@code null} to use the default
   *     values.
  ...
  /**
   * Writes the supplied model to the specified character writer. The writer will be automatically
  ...
  /**
   * Writes the supplied model to the specified byte stream. The stream will be automatically closed
