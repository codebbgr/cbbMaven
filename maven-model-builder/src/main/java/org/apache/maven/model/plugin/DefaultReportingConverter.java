...
public class DefaultReportingConverter implements ReportingConverter {
  ...
  public void convertReporting(
    ...
    if (reportPlugins != null) {
      // new-style report configuration already present: warn since this new style has been
      // deprecated
      ...
      problems.add(
          new ModelProblemCollectorRequest(Severity.WARNING, Version.BASE)
              .setMessage(
                  "Reporting configuration should be done in <reporting> section, "
