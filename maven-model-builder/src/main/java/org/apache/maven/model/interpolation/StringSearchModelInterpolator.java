...
public class StringSearchModelInterpolator extends AbstractStringBasedModelInterpolator {
  ...
  void interpolateObject(
    ...
    List<? extends ValueSource> valueSources =
        createValueSources(model, projectDir, config, problems);
    List<? extends InterpolationPostProcessor> postProcessors =
        createPostProcessors(model, projectDir, config);

    InnerInterpolator innerInterpolator =
        createInterpolator(valueSources, postProcessors, problems);
  ...
  private static final class InterpolateObjectAction implements PrivilegedAction<Object> {
    ...
    InterpolateObjectAction(
        Object target, InnerInterpolator interpolator, ModelProblemCollector problems) {
