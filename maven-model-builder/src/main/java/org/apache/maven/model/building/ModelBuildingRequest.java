...
public interface ModelBuildingRequest {
   ...
   * repository, use {@link #setModelSource(ModelSource)} in combination with a {@link
   * FileModelSource} instead.
   *
   * @param pomFile The POM file of the project to build the effective model for, may be {@code
   *     null} to build the model of some POM from the repository.
   * @return This request, never {@code null}.
   */
  ...
  /**
   * Sets the level of validation to perform on processed models. For building of projects, {@link
   * #VALIDATION_LEVEL_STRICT} should be used to ensure proper building. For the mere retrieval of
   * dependencies during artifact resolution, {@link #VALIDATION_LEVEL_MINIMAL} should be used to
   * account for models of poor quality. By default, models are validated in strict mode.
   *
