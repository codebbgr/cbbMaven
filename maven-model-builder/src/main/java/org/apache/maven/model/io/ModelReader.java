...
public interface ModelReader {
  ...
  /**
   * The key for the option to enable strict parsing. This option is of type {@link Boolean} and
   * defaults to {@code true}. If {@code false}, unknown elements will be ignored instead of causing
   * a failure.
   */
  String IS_STRICT = "org.apache.maven.model.io.isStrict";

  /**
   * The key for the option to enable tracking of line/column numbers. This option is of type {@link
   * org.apache.maven.model.InputSource} and defaults to {@code null}. Providing an input source
   ...
   * @param options The options to use for deserialization, may be {@code null} to use the default
   *     values.
  ...
  /**
   * Reads the model from the specified character reader. The reader will be automatically closed
  ...
  /**
   * Reads the model from the specified byte stream. The stream will be automatically closed before
   * the method returns.
   *
