...
public class DefaultBuildPomXMLFilterFactory extends BuildPomXMLFilterFactory {
  ...
  public DefaultBuildPomXMLFilterFactory(
      TransformerContext context, Consumer<LexicalHandler> lexicalHandlerConsumer) {
  ...
  protected BiFunction<String, String, String> getDependencyKeyToVersionMapper() {
    return (g, a) ->
        Optional.ofNullable(context.getRawModel(g, a)).map(m -> toVersion(m)).orElse(null);
  }
