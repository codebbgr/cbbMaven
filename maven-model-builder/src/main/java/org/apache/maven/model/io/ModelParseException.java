...
/**
 * Signals a failure to parse the POM due to invalid syntax (e.g. non-wellformed XML or unknown
 * elements).
 *
...
public class ModelParseException extends IOException {
   ...
   * @param lineNumber The one-based index of the line containing the error or {@code -1} if
   *     unknown.
   * @param columnNumber The one-based index of the column containing the error or {@code -1} if
   *     unknown.
   */
   ...
   *
   * @return The one-based index of the line containing the error or a non-positive value if
   *     unknown.
   */
   ...
   *
   * @return The one-based index of the column containing the error or non-positive value if
   *     unknown.
   */
