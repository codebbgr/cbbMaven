...
public interface PathTranslator {
  ...
  /**
   * Resolves the specified path against the given base directory. The resolved path will be
   * absolute and uses the platform-specific file separator if a base directory is given. Otherwise,
   * the input path will be returned unaltered.
   *
