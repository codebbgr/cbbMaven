...
public class Result<T> {
   ...
   * @param problems
   */
  public static <T> Result<T> addProblems(
      Result<T> result, Iterable<? extends ModelProblem> problems) {
  ...
  /**
   * Turns the given results into a single result by combining problems and models into single
   * collection.
   *
   * @param results
   */
  public static <T> Result<Iterable<T>> newResultSet(
      Iterable<? extends Result<? extends T>> results) {
