...
/**
 * Holds a model along with some auxiliary information. This internal utility class assists the
 * model builder during POM processing by providing a means to transport information that cannot be
 * (easily) extracted from the model itself.
 *
...
class ModelData {
   ...
   *
   * @return The effective group identifier of the model or an empty string if unknown, never {@code
   *     null}.
   */
   ...
   *
   * @return The effective artifact identifier of the model or an empty string if unknown, never
   *     {@code null}.
   */
